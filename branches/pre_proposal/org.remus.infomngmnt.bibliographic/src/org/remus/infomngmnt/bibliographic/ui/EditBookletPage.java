...
/**
 * Edit page for information unit "Booklet"
 * 
 * @author Andreas Deinlein <dev@deasw.com>
 *
 */
public class EditBookletPage extends BibliographicAbstractInformationFormPage {

	public EditBookletPage() {
		baseTypeId = BibliographicActivator.BOOKLET_TYPE_ID;

...
/**
 * Edit page for information unit "Manual"
 * 
 * @author Andreas Deinlein <dev@deasw.com>
 *
 */
public class EditManualPage extends BibliographicAbstractInformationFormPage {
	
	public EditManualPage() {
		baseTypeId = BibliographicActivator.MANUAL_TYPE_ID;

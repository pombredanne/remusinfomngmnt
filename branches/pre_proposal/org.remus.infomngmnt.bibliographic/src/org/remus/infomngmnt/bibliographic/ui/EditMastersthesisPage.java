...
/**
 * Edit page for information unit "Mastersthesis"
 * 
 * @author Andreas Deinlein <dev@deasw.com>
 *
 */
public class EditMastersthesisPage extends BibliographicAbstractInformationFormPage {
	
	public EditMastersthesisPage() {
		baseTypeId = BibliographicActivator.MASTERSTHESIS_TYPE_ID;

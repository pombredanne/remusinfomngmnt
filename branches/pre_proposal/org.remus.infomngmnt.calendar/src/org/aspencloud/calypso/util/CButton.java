...
//	{ 2,4, 6,4 };
	...
	public CButton(Composite parent, int style, Color fillColor) {
		super(parent, win32 ? SWT.DOUBLE_BUFFERED : SWT.NONE); // GTK does not seem to need it...
		...
		button = new Button(this, bStyle | (win32 ? SWT.DOUBLE_BUFFERED : SWT.NONE)); // GTK does not seem to need it...
	...
	private void disposeFillColor() {
		if(fillColor != null && !fillColor.isDisposed()) fillColor.dispose();
		fillColor = null;
	}

...
public class MultiLineStringFieldEditor extends FieldEditor {
	 ...
	 *            the parent of the field editor's control
	 */
	public MultiLineStringFieldEditor(final String name, final String labelText,
			final Composite parent) {
	...
	public Text getTextControl(final Composite parent) {
		if (this.textField == null) {
			this.textField = new Text(parent, SWT.MULTI | SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL);

...
public class DeleteColumnAction extends Action implements Listener {
	...
	public DeleteColumnAction(final HtmlComposer composer) {
		super("", IAction.AS_PUSH_BUTTON);
		setToolTipText("Delete selected column(s).");
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(
				"de.spiritlink.richhtml4eclipse",
				"tiny_mce/jscripts/tiny_mce/plugins/table/images/table_delete_col.gif"));

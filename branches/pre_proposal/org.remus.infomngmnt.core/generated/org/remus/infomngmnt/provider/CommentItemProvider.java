...
/**
 * This is the item provider adapter for a {@link org.remus.infomngmnt.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InfomngmntPackage.Literals.COMMENT__AUTHOR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InfomngmntPackage.Literals.COMMENT__COMMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRatingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_rating_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_rating_feature", "_UI_Comment_type"),
				 InfomngmntPackage.Literals.COMMENT__RATING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Comment)object).getAuthor();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Comment.class)) {
			case InfomngmntPackage.COMMENT__AUTHOR:
			case InfomngmntPackage.COMMENT__COMMENT:
			case InfomngmntPackage.COMMENT__RATING:

...
public abstract class AbstractSpellDictionary implements ISpellDictionary {
	 ...
	 */
	protected final Set getCandidates(final String word, final boolean sentence,
			final ArrayList hashs) {
	 ...
	 * @since 3.3
	 */
	public void setStripNonLetters(final boolean state) {
	 ...
	 * @since 3.3
	 */
	protected String stripNonLetters(final String word) {

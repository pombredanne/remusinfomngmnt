...
public class ChangeCaseProposal extends WordCorrectionProposal {
	...
	public ChangeCaseProposal(final String[] arguments, final int offset, final int length,
		...
		super(Character.isLowerCase(arguments[0].charAt(0)) ? Character.toUpperCase(arguments[0]
				.charAt(0))
				+ arguments[0].substring(1) : arguments[0], arguments, offset, length, context,
				Integer.MAX_VALUE);
	}
	...
	public String getDisplayString() {
		return Messages.ChangeCaseProposal_ChangeCase;
	}
}

...
public class WelcomePage extends FormPage {
	...
	protected void createFormContent(final IManagedForm managedForm) {
		...
		section
				.setDescription("Welcome to the Remus Information Management. This application allows you to store all you incoming information in an easy and comfortable way. Check out the following links to see what RIM can do for you.");

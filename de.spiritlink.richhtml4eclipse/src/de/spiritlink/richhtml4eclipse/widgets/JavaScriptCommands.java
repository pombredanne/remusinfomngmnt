...
public final class JavaScriptCommands {
    ...
    public static String INSERT_IMAGE(final String source, final String alt, final String border, final String hspace, final String vspace, final String width, final String height, final String align) {
    ...
    public static String INSERT_LINK(final String href, final String title, final String target, final String clazz) {
        StringBuffer returnValue = new StringBuffer("javascript:") //$NON-NLS-1$
    ...
    public static String FORECOLOR(RGB rgb) {
        StringBuffer returnValue = new StringBuffer("javascript:") //$NON-NLS-1$
            .append("tinyMCE.execInstanceCommand('mce_editor_0','ForeColor',false,\'#") //$NON-NLS-1$
    ...
    public static String BACKCOLOR(RGB rgb) {
        StringBuffer returnValue = new StringBuffer("javascript:") //$NON-NLS-1$
        .append("tinyMCE.execInstanceCommand('mce_editor_0','BackColor',false,\'#") //$NON-NLS-1$
        .append(ColorConverter.convertRgbToHex(rgb)).append("\');"); //$NON-NLS-1$
        return returnValue.toString();
        
    }
    
    public static String INSERT_EDIT_TABLE(String cellpadding, String cellspacing, String align, String clazz, String style, String id) {
        StringBuffer returnValue = new StringBuffer("javascript:_bridgeInsertEditTable(\'") //$NON-NLS-1$
            .append(cellpadding).append("\',\'").append(cellspacing).append("\',\'0\',\'").append(align) //$NON-NLS-1$ //$NON-NLS-2$

...
package org.remus.infomngmnt.birtbridge.handler;
 ...
 */
public class OpenReportInEditModeHandler extends AbstractHandler {
			...
			try {
				...
				IPerspectiveDescriptor findPerspectiveWithId = PlatformUI
						...
						.findPerspectiveWithId(
								"org.eclipse.birt.report.designer.ui.ReportRCPPerspective"); //$NON-NLS-1$

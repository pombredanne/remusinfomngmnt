...
public class CalendarView extends ViewPart implements ISelectionChangedListener {
	...
	private void createActions() {
		...
		this.createAction = new CreateAction(new GraphicalViewer[] {
				this.calendar.getTasksViewer(), this.calendar.getActivitiesViewer() });
	...
	private void createContextMenu() {
		GraphicalViewer[] gviewers = new GraphicalViewer[] { this.calendar.getActivitiesViewer(),
				this.calendar.getTasksViewer() };

...
package org.remus.infomngmnt.connector.youtube.actions;
 ...
 */
public class CheckoutFeedAction extends BaseSelectionListenerAction {

	public CheckoutFeedAction() {
		super("Categories");
	...
	public void run() {
		...
		ChangeSet changeSet = manager.createCheckOutChangeSet(null, getStructuredSelection().toList(), null, ChangeSetManager.MODE_CHECKOUT_REPLACE, null);
		if (changeSet != null) {

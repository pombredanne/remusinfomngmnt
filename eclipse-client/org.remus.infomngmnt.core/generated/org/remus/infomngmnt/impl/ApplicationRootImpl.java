...
public class ApplicationRootImpl extends EObjectImpl implements ApplicationRoot {
		...
		if (availableTags != null && availableTags.eIsProxy()) {
			...
			if (availableTags != oldAvailableTags) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InfomngmntPackage.APPLICATION_ROOT__AVAILABLE_TAGS, oldAvailableTags, availableTags));
			}
		}
	...
	public void setAvailableTags(AvailableTags newAvailableTags) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfomngmntPackage.APPLICATION_ROOT__AVAILABLE_TAGS, oldAvailableTags, availableTags));
	}

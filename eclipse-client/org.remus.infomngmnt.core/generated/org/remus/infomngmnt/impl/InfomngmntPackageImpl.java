...
public class InfomngmntPackageImpl extends EPackageImpl implements InfomngmntPackage {
	...
	public EReference getInformationUnit_UsageData() {
		return (EReference)informationUnitEClass.getEStructuralFeatures().get(10);
	}
	...
	public EAttribute getInformationUnit_Keywords() {
		return (EAttribute)informationUnitEClass.getEStructuralFeatures().get(12);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getInformationStructureItem_CreateAlways(), ecorePackage.getEBoolean(), "createAlways", null, 0, 1, InformationStructureItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(informationStructureTypeEEnum, InformationStructureType.DATE);

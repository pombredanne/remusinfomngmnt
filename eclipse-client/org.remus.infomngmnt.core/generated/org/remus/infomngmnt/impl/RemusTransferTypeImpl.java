...
public class RemusTransferTypeImpl extends EObjectImpl implements RemusTransferType {
	...
	protected EClass eStaticClass() {
		return InfomngmntPackage.Literals.REMUS_TRANSFER_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfomngmntPackage.REMUS_TRANSFER_TYPE__NAME, oldName, name));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfomngmntPackage.REMUS_TRANSFER_TYPE__ID, oldId, id));
	}

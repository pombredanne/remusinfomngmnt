...
package org.remus.infomngmnt.core.ruledefinitions;
 ...
 */
public class DropFromTextTransfer extends AbstractRuleDefinition implements
ICondition {

	/**
	 * 
	 */
	public DropFromTextTransfer() {
	...
	public String getStringRepresentation() {
		return "Dropped/Pasted content is structurable as plain text";
	}

...
public class CommentImageDialog extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public CommentImageDialog(final Shell parentShell, final InformationUnit image,
	...
	protected Control createDialogArea(final Composite parent) {
		...
		// vf.setLayoutData(new GridData(SWT.BEGINNING, SWT.BEGINNING, false,
		// false));

		ToolBarManager tbm = new ToolBarManager(SWT.FLAT | SWT.HORIZONTAL | SWT.RIGHT);
		long width = InformationUtil.getChildByType(this.image, ImagePlugin.NODE_NAME_WIDTH)
				.getLongValue();
		long height = InformationUtil.getChildByType(this.image, ImagePlugin.NODE_NAME_HEIGHT)
				.getLongValue();
		...
		deleteLinkAction.setImageDescriptor(PlatformUI.getWorkbench().getSharedImages()

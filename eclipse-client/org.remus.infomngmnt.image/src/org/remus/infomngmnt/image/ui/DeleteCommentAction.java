 ...
 */
public class DeleteCommentAction extends BaseSelectionListenerAction implements IEditingDomainHolder{
	...
	public void run() {
		...
		for (Object object : list) {
			if (((EditPart) object).getModel() instanceof ShapableInfoDelegate) {
				InformationUnit origInfoObject = ((ShapableInfoDelegate) ((EditPart) object).getModel()).getOrigInfoObject();

...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Calendar Entry Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.remus.infomngmnt.InfomngmntPackage#getCalendarEntryType()
 * @model
 * @generated
 */
public enum CalendarEntryType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Calendar Entry Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CalendarEntryType[] VALUES_ARRAY =
	...
	/**
	 * A public read-only list of all the '<em><b>Calendar Entry Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CalendarEntryType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Calendar Entry Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CalendarEntryType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CalendarEntryType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Calendar Entry Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CalendarEntryType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CalendarEntryType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Calendar Entry Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CalendarEntryType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private CalendarEntryType(int value, String name, String literal) {
		this.value = value;
		this.name = name;

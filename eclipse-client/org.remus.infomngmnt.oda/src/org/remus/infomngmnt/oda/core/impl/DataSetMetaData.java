...
public class DataSetMetaData implements IDataSetMetaData {
	...
	DataSetMetaData(final IConnection connection) {
	 ...
	 */
	public IResultSet getDataSourceObjects(final String catalog, final String schema,
			final String object, final String version) throws OdaException {
		throw new UnsupportedOperationException();
	}

	/*
	 * @seeorg.eclipse.datatools.connectivity.oda.IDataSetMetaData#

...
public class ToggleVisualAidAction extends Action implements Listener{
    ...
    public ToggleVisualAidAction(HtmlComposer composer) {
        ...
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("de.spiritlink.richhtml4eclipse", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/visualaid.gif"));

 ...
 */
public class RichTextCreationFactory extends AbstractCreationFactory {

	/**
	 * 
	 */
	public RichTextCreationFactory() {
		// TODO Auto-generated constructor stub
	}
	
	@Override
	public InformationUnit createNewObject() {
		InformationUnit createNewObject = super.createNewObject();
		createNewObject.setType(RichTextPlugin.TYPE_ID);

...
public class SearchAgainHandler extends AbstractHandler {
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		if (editorInput instanceof URIEditorInput) {
			...
			ISearchService service = SearchUIActivator.getDefault().getServiceTracker().getService(
					ISearchService.class);
			service.search(search, true);
			SearchUIActivator.getDefault().getServiceTracker().ungetService(service);
		}
		return null;
	}
}

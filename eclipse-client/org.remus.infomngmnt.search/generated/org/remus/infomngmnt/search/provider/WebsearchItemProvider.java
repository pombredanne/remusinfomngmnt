 ...
 * @generated
 */
public class WebsearchItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Websearch_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Websearch_id_feature", "_UI_Websearch_type"),
				 SearchPackage.Literals.WEBSEARCH__ID,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Websearch_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Websearch_name_feature", "_UI_Websearch_type"),
				 SearchPackage.Literals.WEBSEARCH__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPatternPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Websearch_pattern_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Websearch_pattern_feature", "_UI_Websearch_type"),
				 SearchPackage.Literals.WEBSEARCH__PATTERN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addImagePathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Websearch_imagePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Websearch_imagePath_feature", "_UI_Websearch_type"),
				 SearchPackage.Literals.WEBSEARCH__IMAGE_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addContributorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Websearch_contributor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Websearch_contributor_feature", "_UI_Websearch_type"),
				 SearchPackage.Literals.WEBSEARCH__CONTRIBUTOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Websearch_type") :
			getString("_UI_Websearch_type") + " " + label;
	}

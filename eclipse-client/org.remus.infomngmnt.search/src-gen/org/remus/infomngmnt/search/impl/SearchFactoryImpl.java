...
public class SearchFactoryImpl extends EFactoryImpl implements SearchFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SearchPackage.SECONDARY_GROUP_CONTAINER: return createSecondaryGroupContainer();
			default:
	 ...
	 * @generated
	 */
	public SecondaryGroupContainer createSecondaryGroupContainer() {
		SecondaryGroupContainerImpl secondaryGroupContainer = new SecondaryGroupContainerImpl();
		return secondaryGroupContainer;
	}

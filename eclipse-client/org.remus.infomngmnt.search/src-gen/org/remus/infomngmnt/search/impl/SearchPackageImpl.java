...
public class SearchPackageImpl extends EPackageImpl implements SearchPackage {
	 ...
	 * @generated
	 */
	private EClass secondaryGroupContainerEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getSearchResult_Query() {
	 ...
	 * @generated
	 */
	public EReference getSearchResult_SecondaryResults() {
		return (EReference)searchResultEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EClass getSecondaryGroupContainer() {
		return secondaryGroupContainerEClass;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(searchResultEClass, SEARCH_RESULT__QUERY);
		createEReference(searchResultEClass, SEARCH_RESULT__SECONDARY_RESULTS);
		...
		secondaryGroupContainerEClass = createEClass(SECONDARY_GROUP_CONTAINER);
	...
	public void initializePackageContents() {
		...
		secondaryGroupContainerEClass.getESuperTypes().add(this.getSearchResult());
		...
		initEAttribute(getSearchResult_Query(), ecorePackage.getEString(), "query", null, 0, 1, SearchResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSearchResult_SecondaryResults(), this.getSearchResult(), null, "secondaryResults", null, 0, -1, SearchResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(secondaryGroupContainerEClass, SecondaryGroupContainer.class, "SecondaryGroupContainer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

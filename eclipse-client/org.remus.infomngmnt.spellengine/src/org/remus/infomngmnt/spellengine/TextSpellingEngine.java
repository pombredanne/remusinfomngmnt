...
public class TextSpellingEngine extends SpellingEngine {
	 ...
	 * org.eclipse.jdt.internal.ui.text.spelling.engine.ISpellChecker,
	 * org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector,
	 * org.eclipse.core.runtime.IProgressMonitor)
	 */
	@Override
	protected void check(final IDocument document, final IRegion[] regions,
			final ISpellChecker checker, final ISpellingProblemCollector collector,
		...
		for (int i = 0; i < regions.length; i++) {
			...
			if (listener.isProblemsThresholdReached())
				return;
			checker.execute(listener, new SpellCheckIterator(document, regions[i], checker
					.getLocale()));
		}
	}
}

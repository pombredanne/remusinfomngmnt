...
public class RulesSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RulesPackage.VDESKTOP_RULE_ENGINE_V: {
				V__________DesktopRuleEngine_________V v__________DesktopRuleEngine_________V = (V__________DesktopRuleEngine_________V)theEObject;
				T result = caseV__________DesktopRuleEngine_________V(v__________DesktopRuleEngine_________V);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RulesPackage.STRING_TO_STRING_MAP: {
				@SuppressWarnings("unchecked") Map.Entry<String, String> stringToStringMap = (Map.Entry<String, String>)theEObject;
				T result = caseStringToStringMap(stringToStringMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RulesPackage.NEW_ELEMENT_RULES: {
				NewElementRules newElementRules = (NewElementRules)theEObject;
				T result = caseNewElementRules(newElementRules);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RulesPackage.RULE_VALUE: {
				RuleValue ruleValue = (RuleValue)theEObject;
				T result = caseRuleValue(ruleValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RulesPackage.AVAILABLE_RULE_DEFINITIONS: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>VDesktop Rule Engine V</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>VDesktop Rule Engine V</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseV__________DesktopRuleEngine_________V(V__________DesktopRuleEngine_________V object) {
		return null;
	}

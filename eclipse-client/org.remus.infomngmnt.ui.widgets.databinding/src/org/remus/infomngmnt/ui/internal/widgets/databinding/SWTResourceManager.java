package org.remus.infomngmnt.ui.internal.widgets.databinding;
...
public class SWTResourceManager {
	...
	public static void disposeImages() {
		...
		//
		for (Iterator<HashMap<Image, Image>> I = m_ImageToDecoratorMap.values().iterator(); I
				.hasNext();) {
	 ...
	 * @return Font The bold version of the give font
	 */
	public static Font getItalicFont(final Font baseFont) {
	...
	public static void disposeFonts() {
		...
		for (Iterator<Font> iter = m_FontToItalicFontMap.values().iterator(); iter.hasNext();) {
			iter.next().dispose();
		}

...
public class CreateInfoTypeCommand extends CompoundCommand {
	...
	public CreateInfoTypeCommand(InformationUnit newInformationUnit, Category parentCategory) {
	...
	private void postExcecute() {
		...
		try {
			PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(new InformationEditorInput(this.createInformationUnitListItem), InformationEditor.ID);

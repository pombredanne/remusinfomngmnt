...
public class DynamicStructureImpl extends InformationStructureItemImpl implements DynamicStructure {
	...
	public void setLowerBound(int newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfomngmntPackage.DYNAMIC_STRUCTURE__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(int newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfomngmntPackage.DYNAMIC_STRUCTURE__UPPER_BOUND, oldUpperBound, upperBound));
	}

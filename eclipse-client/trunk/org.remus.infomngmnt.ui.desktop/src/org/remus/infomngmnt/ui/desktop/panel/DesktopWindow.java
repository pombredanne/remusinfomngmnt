...
package org.remus.infomngmnt.ui.desktop.panel;
...
import org.remus.infomngmnt.ui.popup.AbstractDesktopWindow;
import org.remus.infomngmnt.ui.popup.SwtFadeUtil;
...
public class DesktopWindow extends AbstractDesktopWindow {
	...
	protected void createContentArea(final Composite parent) {
		...
		TraySectionCollection sections = UimodelEditPlugin.getPlugin().getServiceTracker()
				.getService(ITrayConfigurationService.class).getTraySections();

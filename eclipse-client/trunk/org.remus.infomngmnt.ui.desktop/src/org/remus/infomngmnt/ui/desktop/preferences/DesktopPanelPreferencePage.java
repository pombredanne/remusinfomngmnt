...
package org.remus.infomngmnt.ui.desktop.preferences;
...
import org.remus.uimodel.util.UimodelAdapterFactory;
...
public class DesktopPanelPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	private ITrayConfigurationService service;
	...
	public void init(final IWorkbench workbench) {
		this.service = UimodelEditPlugin.getPlugin().getServiceTracker().getService(
				ITrayConfigurationService.class);
		this.sections = this.service.getTraySections();

		this.adapterFactory = new ComposedAdapterFactory(
				ComposedAdapterFactory.Descriptor.Registry.INSTANCE);
		this.adapterFactory.addAdapterFactory(new ResourceItemProviderAdapterFactory());
		this.adapterFactory.addAdapterFactory(new UimodelAdapterFactory());

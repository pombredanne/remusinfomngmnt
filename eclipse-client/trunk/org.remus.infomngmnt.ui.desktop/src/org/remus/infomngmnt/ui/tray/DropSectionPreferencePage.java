...
public class DropSectionPreferencePage extends AbstractTrayPreferencePage {
	...
	public void createControl(final Composite parent) {
		...
		ruleSetLabel.setLayoutData(new GridData(SWT.BEGINNING, SWT.CENTER, false, false));
	...
	public void bindValuesToUi() {
		...
		this.nameText.addListener(SWT.Modify, new Listener() {
			public void handleEvent(final Event event) {
				DropSectionPreferencePage.this.section
						.setName(DropSectionPreferencePage.this.nameText.getText());
			}
		});
		List featureList = ModelUtil.getFeatureList(UimodelEditPlugin.getPlugin()
				.getServiceTracker().getService(IRuleService.class).getElementRules()
				.getNewElementRules(), RulesPackage.Literals.NEW_ELEMENT_RULES__NAME);

 ...
 */
public class InfomngmntActionBarContributor extends MultiPageEditorActionBarContributor implements
		IMenuListener, IPropertyListener {
	...
	class CutAction extends ClipboardAction {
		...
		public void selectionChanged(final ISelection selection) {
			setEnabled(isEditable()
					&& InfomngmntActionBarContributor.this.activeEditor.canCut(selection));
		}
	}
	...
	class PasteAction extends ClipboardAction {
		...
		public void selectionChanged(final ISelection selection) {
			setEnabled(isEditable()
					&& InfomngmntActionBarContributor.this.activeEditor.canPasteFromClipboard());
	...
	public void deactivate() {
		...
		ISelectionProvider selectionProvider = this.activeEditor instanceof ISelectionProvider ? (ISelectionProvider) this.activeEditor

...
import org.remus.infomngmnt.ui.remote.view.action.DeleteRepositoryAction;
import org.remus.infomngmnt.ui.remote.view.action.RefreshRemoteObjectAction;
...
public class RemoteRepositoryContextMenu implements IMenuListener, IPropertyListener,
	...
	private AddRemoteRepositoryAction newAction;
	...
	public void init(final IActionBars actionBars) {
		...
		DisposableEditingDomain createNewEditingDomain = RemoteUiActivator.getDefault()
				.getEditService().createNewEditingDomain();

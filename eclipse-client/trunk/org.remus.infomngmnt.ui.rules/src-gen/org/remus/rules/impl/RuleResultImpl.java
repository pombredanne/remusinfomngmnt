 ...
 * <ul>
 *   <li>{@link org.remus.rules.impl.RuleResultImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.remus.rules.impl.RuleResultImpl#getActions <em>Actions</em>}</li>
 *   <li>{@link org.remus.rules.impl.RuleResultImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.remus.rules.impl.RuleResultImpl#getTransferType <em>Transfer Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleResultImpl extends EObjectImpl implements RuleResult {
	...
	protected EClass eStaticClass() {
		return RulesPackage.Literals.RULE_RESULT;
	}
	...
	public void setValue(Object newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RULE_RESULT__VALUE, oldValue, value));
	}
	...
	public EList<RuleAction> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentEList<RuleAction>(RuleAction.class, this, RulesPackage.RULE_RESULT__ACTIONS);
		}
		return actions;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RULE_RESULT__DESCRIPTION, oldDescription, description));
	}
	...
	public void setTransferType(TransferWrapper newTransferType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RULE_RESULT__TRANSFER_TYPE, oldTransferType, transferType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RulesPackage.RULE_RESULT__ACTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RulesPackage.RULE_RESULT__VALUE:
				return getValue();
			case RulesPackage.RULE_RESULT__ACTIONS:
				return getActions();
			case RulesPackage.RULE_RESULT__DESCRIPTION:
				return getDescription();
			case RulesPackage.RULE_RESULT__TRANSFER_TYPE:

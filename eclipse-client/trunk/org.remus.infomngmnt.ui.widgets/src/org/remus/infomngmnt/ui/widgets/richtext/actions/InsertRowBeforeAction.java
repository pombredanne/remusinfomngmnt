...
public class InsertRowBeforeAction extends Action implements Listener {
	...
	public InsertRowBeforeAction(final HtmlComposer composer) {
		super("Insert row before", IAction.AS_PUSH_BUTTON);
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(
				"de.spiritlink.richhtml4eclipse",
				"tiny_mce/jscripts/tiny_mce/plugins/table/images/table_insert_row_before.gif"));

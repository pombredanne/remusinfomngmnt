...
public class JustifyCenterAction extends Action implements Listener {
	...
	public JustifyCenterAction(final HtmlComposer composer) {
		super("Align center", IAction.AS_CHECK_BOX);
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(
				"de.spiritlink.richhtml4eclipse",
				"tiny_mce/jscripts/tiny_mce/themes/advanced/images/justifycenter.gif"));

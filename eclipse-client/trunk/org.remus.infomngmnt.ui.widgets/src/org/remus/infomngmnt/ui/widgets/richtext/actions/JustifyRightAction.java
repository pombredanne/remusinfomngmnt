...
public class JustifyRightAction extends Action implements Listener {
	...
	public JustifyRightAction(final HtmlComposer composer) {
		super("Align right", IAction.AS_CHECK_BOX);
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(
				"de.spiritlink.richhtml4eclipse",
				"tiny_mce/jscripts/tiny_mce/themes/advanced/images/justifyright.gif"));

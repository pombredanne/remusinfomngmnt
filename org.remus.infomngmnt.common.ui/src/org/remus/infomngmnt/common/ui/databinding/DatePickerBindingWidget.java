 ...
 */
public class DatePickerBindingWidget extends AbstractBindingWidget {
	...
	public void bindModel(EObject object, EStructuralFeature feature,
		...
		IObservableValue swtObs = ViewersObservables
				.observeSingleSelection((ISelectionProvider) getWrappedControl());

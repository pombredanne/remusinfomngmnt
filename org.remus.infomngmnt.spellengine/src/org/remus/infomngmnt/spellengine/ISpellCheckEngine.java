...
public interface ISpellCheckEngine {
	...
	/**
	 * Returns a spell checker configured with the global dictionaries and the
	 * locale dictionary that correspond to the current
	 * {@linkplain PreferenceConstants#SPELLING_LOCALE locale preference}.
	 * <p>
	 * <strong>Note:</strong> Changes to the spelling engine dictionaries are
	 * not propagated to this spell checker.
	 * </p>
	 * 
	 * @return a configured instance of the spell checker or <code>null</code>
	 *         if none
	 * @throws IllegalStateException
	 *             if called after being shut down
	 */

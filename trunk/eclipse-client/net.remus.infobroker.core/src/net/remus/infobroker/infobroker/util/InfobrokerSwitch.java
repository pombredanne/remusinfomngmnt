 ...
 * @generated
 */
public class InfobrokerSwitch<T> {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case InfobrokerPackage.VALUE: {
                Value value = (Value)theEObject;
                T result = caseValue(value);
                if (result == null) result = caseNode(value);
                if (result == null) result = caseBase(value);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case InfobrokerPackage.CREDENTIALS: {
                Credentials credentials = (Credentials)theEObject;
                T result = caseCredentials(credentials);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case InfobrokerPackage.BASE: {
                Base base = (Base)theEObject;
                T result = caseBase(base);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case InfobrokerPackage.PRIMARY_NODE: {
                PrimaryNode primaryNode = (PrimaryNode)theEObject;
                T result = casePrimaryNode(primaryNode);
                if (result == null) result = caseValue(primaryNode);
                if (result == null) result = caseNode(primaryNode);
                if (result == null) result = caseBase(primaryNode);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Primary Node</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Primary Node</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T casePrimaryNode(PrimaryNode object) {
        return null;
    }

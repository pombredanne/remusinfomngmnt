...
public class WelcomePage extends FormPage {
	 ...
	 * @param title
	 */
	public WelcomePage(final FormEditor editor, final String id,
			final String title) {
	...
	protected void createFormContent(final IManagedForm managedForm) {
		...
		final Section section = toolkit
				.createSection(body, Section.DESCRIPTION);
		section.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
		section.setDescription("Welcome to the Remus Information Management. This application allows you to store all you incoming information in an easy and comfortable way. Check out the following links to see what RIM can do for you."); //$NON-NLS-1$
		...
		final ImageHyperlink learnRimInImageHyperlink = toolkit
				.createImageHyperlink(body, SWT.NONE);
		learnRimInImageHyperlink.setLayoutData(new GridData(SWT.LEFT,
				SWT.CENTER, true, false));
		learnRimInImageHyperlink.setText("Learn RIM in 5 Minutes (Video)"); //$NON-NLS-1$

		final Section linksSection = toolkit.createSection(body, SWT.NONE);
		linksSection.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true,
				false));
		linksSection.setText("Links"); //$NON-NLS-1$
		...
		imageHyperlink_1.setLayoutData(new TableWrapData(TableWrapData.FILL,
				TableWrapData.TOP));
		imageHyperlink_1.setText("New ImageHyperlink"); //$NON-NLS-1$
		...
		imageHyperlink.setLayoutData(new TableWrapData(TableWrapData.FILL,
				TableWrapData.TOP));
		imageHyperlink.setText("New ImageHyperlink"); //$NON-NLS-1$

		final ImageHyperlink imageHyperlink_2 = toolkit.createImageHyperlink(
				composite_2, SWT.NONE);
		imageHyperlink_2.setText("New ImageHyperlink"); //$NON-NLS-1$
		...
		latestNewsSection.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true,
				true));
		latestNewsSection.setText("Latest News"); //$NON-NLS-1$
		...
		browser.setUrl("http://www.eclipse.org"); //$NON-NLS-1$

		final Button button = toolkit.createButton(body,
				"Show this page on startup", SWT.CHECK); //$NON-NLS-1$

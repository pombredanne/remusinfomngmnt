...
import org.remus.infomngmnt.bibliographic.extension.BibtexExportOperation;

public class BibtexExportWizard extends Wizard implements IExportWizard {

	private BibtexExportWizardPage exportPage = null;
	private Category selCategory = null;
	
	private final static String SETTINGS_SECTION = "org.remus.infomngmnt.bibliographic.ui.bibtexExportWizard"; //$NON-NLS-1$
	
	public BibtexExportWizard() {
		IDialogSettings masterSettings = BibliographicActivator.getDefault().getDialogSettings();
		setDialogSettings(getSettingsSection(masterSettings));
		setNeedsProgressMonitor(true);
		setWindowTitle("BibTex export wizard");
	}
	...
	public void addPages() {
		exportPage = new BibtexExportWizardPage();
	...
	public boolean performFinish() {
		...
		BibtexExportOperation job = new BibtexExportOperation(selCategory, destFile);

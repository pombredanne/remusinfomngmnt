...
/**
 * Edit page for information unit "Incollection"
 * 
 * @author Andreas Deinlein <dev@deasw.com>
 *
 */
public class EditIncollectionPage extends BibliographicAbstractInformationFormPage {
	
	public EditIncollectionPage() {
		baseTypeId = BibliographicActivator.INCOLLECTION_TYPE_ID;

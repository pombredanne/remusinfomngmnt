...
/**
 * Edit page for information unit "Inproceedings"
 * 
 * @author Andreas Deinlein <dev@deasw.com>
 *
 */
public class EditInproceedingsPage extends BibliographicAbstractInformationFormPage {
	
	public EditInproceedingsPage() {
		baseTypeId = BibliographicActivator.INPROCEEDINGS_TYPE_ID;

	...
	private void createExportDirectoryControl(final Composite parent) {
		...
		this.exportEleButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				...
				dialog.setInitialSelection(XmlExportWizardPage.this.selectedCategory);
				if (dialog.open() == IDialogConstants.OK_ID) {
					Object[] result = dialog.getResult();
					Category selectedCategory = (Category) result[0];
					XmlExportWizardPage.this.exportEleText.setText(CategoryUtil
		...
		this.browseButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				...
				if (!open.contains(".xml"))
					XmlExportWizardPage.this.destDirText.setText(open + ".xml");
				else
					XmlExportWizardPage.this.destDirText.setText(open);
				controlChanged();
			}
		});
	}

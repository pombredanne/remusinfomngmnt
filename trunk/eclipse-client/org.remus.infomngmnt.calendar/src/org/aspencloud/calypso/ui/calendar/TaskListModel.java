...
public class TaskListModel extends BaseModel {
	...
	public static final String PROP_TASK_TYPE = "task_type"; //$NON-NLS-1$
	public static final String PROP_EVENT_DATE = "event_date"; //$NON-NLS-1$
	...
	public void add(Task task, Task parent) {
		refresh();
	}
	...
	public void setInput(Tasklist input) {
		this.input = input;
		if (provider != null) {
			provider.inputChanged(null, this, input);
		}
		refresh();
	}

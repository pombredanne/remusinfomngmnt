...
public class DueEventImpl extends CEventImpl implements DueEvent {
	...
	public void setTask(Task newTask) {
		if (newTask != eInternalContainer() || (eContainerFeatureID() != ModelPackage.DUE_EVENT__TASK && newTask != null)) {
			...
			if (newTask != null)
				msgs = ((InternalEObject)newTask).eInverseAdd(this, ModelPackage.TASK__DUE, Task.class, msgs);
			msgs = basicSetTask(newTask, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DUE_EVENT__TASK, newTask, newTask));
	}

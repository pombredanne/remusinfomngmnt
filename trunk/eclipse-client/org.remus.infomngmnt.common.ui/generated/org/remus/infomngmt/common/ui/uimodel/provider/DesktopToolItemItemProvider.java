 ...
 * @generated
 */
public class DesktopToolItemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DesktopToolItem_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DesktopToolItem_id_feature", "_UI_DesktopToolItem_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DesktopToolItem_name_feature", "_UI_DesktopToolItem_type"),
				 UIModelPackage.Literals.DESKTOP_TOOL_ITEM__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addImagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DesktopToolItem_image_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DesktopToolItem_image_feature", "_UI_DesktopToolItem_type"),
				 UIModelPackage.Literals.DESKTOP_TOOL_ITEM__IMAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_DesktopToolItem_type") :
			getString("_UI_DesktopToolItem_type") + " " + label;
	}

 ...
 * 
 */
public class SubAction extends Action implements Listener{
    private HtmlComposer composer = null;

    public SubAction(HtmlComposer composer) {
        super("", IAction.AS_CHECK_BOX);
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("de.spiritlink.richhtml4eclipse", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/sub.gif"));
        this.composer = composer;
        this.composer.addListener(EventConstants.SUB, this);
    }
    ...
    @Override
    public void run() {
        this.composer.execute(JavaScriptCommands.SUB);
    }

 ...
 * 
 */
public class UnlinkAction extends Action implements Listener {
    
    private HtmlComposer composer = null;
    
    public UnlinkAction(HtmlComposer composer) {
        super("", IAction.AS_CHECK_BOX);
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("de.spiritlink.richhtml4eclipse", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/unlink.gif"));
        this.composer = composer;
        this.composer.addListener(EventConstants.UNLINK, this);
    }
    ...
    @Override
    public void run() {
        this.composer.execute(JavaScriptCommands.UNLINK);
    }

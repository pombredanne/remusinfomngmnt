 ...
 */
public class NewReadonlyYoutubeRepositoryWizard extends NewRepositoryWizard {

	private YoutubeConnectionWizardPage page1;
	...
	public void init(final IStructuredSelection selection) {
		...
		this.page1 = new YoutubeConnectionWizardPage();
	}

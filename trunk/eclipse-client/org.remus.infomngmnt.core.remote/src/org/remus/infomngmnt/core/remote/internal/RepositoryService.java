...
public class RepositoryService implements IRepositoryService {
	 ...
	 * 
	 * @see
	 * org.remus.infomngmnt.core.services.IRepositoryService#getRepositories()
	 */
	public RepositoryCollection getRepositories() {
		if (this.repositories == null) {
			IPath append = RemoteActivator.getDefault().getStateLocation().append(REPOSITORY_PATH);
			this.repositories = this.editService.getObjectFromFileUri(URI.createFileURI(append
					.toOSString()), InfomngmntPackage.Literals.REPOSITORY_COLLECTION, null);
		}
	 ...
	 * 
	 * @see
	 * org.remus.infomngmnt.core.services.IRepositoryService#getRepositoryById
	 * (java.lang.String)
	 */

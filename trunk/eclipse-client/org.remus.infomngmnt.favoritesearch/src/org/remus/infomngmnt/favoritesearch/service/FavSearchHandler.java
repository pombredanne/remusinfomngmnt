...
public class FavSearchHandler implements IFavoriteSearchHandler {
	...
	/* (non-Javadoc)
	 * @see org.remus.infomngmnt.search.service.IFavoriteSearchHandler#addToFavorites(org.remus.infomngmnt.search.Search)
	 */
	public void addToFavorites(Search search) {

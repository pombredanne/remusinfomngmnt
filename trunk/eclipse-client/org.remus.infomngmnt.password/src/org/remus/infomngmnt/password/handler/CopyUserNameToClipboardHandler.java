 ...
 */
public class CopyUserNameToClipboardHandler extends CopyToClipboardHandler {
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		if (unit != null) {
			copyToCliboard(event, InformationUtil
					.getChildByType(unit, PasswordPlugin.NODE_USERNAME).getStringValue(),

...
package org.remus.infomngmnt.search.ui.context;
...
public class SearchContextProvider {
	...
	public void activate(final EList<SearchResult> list, final int index) {
		deactivate();
	...
	public void openNextResult() {
		if (isActivated()) {
			...
			EditorUtil.openInfoUnit(this.searchResultList.get(this.index).getInfoId());
		}
	}

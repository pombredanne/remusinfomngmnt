...
public class SearchItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDateStartPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Search_searchString_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Search_searchString_feature", "_UI_Search_type"),
	...
	/**
	 * This adds a property descriptor for the Date Start feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDateStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Search_dateStart_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Search_dateStart_feature", "_UI_Search_type"),
	...
	protected void addEndDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Search_endDate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Search_endDate_feature", "_UI_Search_type"),
	...
	protected void addInfoTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Search_infoType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Search_infoType_feature", "_UI_Search_type"),
	...
	protected void addScopePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Search_scope_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Search_scope_feature", "_UI_Search_type"),
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Search_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Search_id_feature", "_UI_Search_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SearchPackage.Literals.SEARCH__RESULT);
		}
	...
	public String getText(Object object) {
		String label = ((Search)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SearchPackage.Literals.SEARCH__RESULT,
				 SearchFactory.eINSTANCE.createSearchResult()));
	}

...
public class SearchAdapterFactory extends AdapterFactoryImpl {
	...
	protected SearchSwitch<Adapter> modelSwitch =
		new SearchSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSecondaryGroupContainer(SecondaryGroupContainer object) {
				return createSecondaryGroupContainerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.remus.infomngmnt.search.SecondaryGroupContainer <em>Secondary Group Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSecondaryGroupContainerAdapter() {
		return null;
	}

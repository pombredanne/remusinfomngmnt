...
package org.remus.infomngmnt.ui.remote.propertytester;
	...
	public boolean test(final Object receiver, final String property, final Object[] args,
		...
		if (receiver instanceof SynchronizableObject) {
			...
			if (REPOSITORY_PROPERTY.equals(property)) {
				if (metaData != null) {
					IRepositoryExtensionService itemById = UIPlugin.getDefault().getService(
							IRepositoryExtensionService.class);
					if (itemById != null) {
						return expectedValue.equals(itemById.getItemByLocalObject(
								(SynchronizableObject) receiver).getId());
					}
				}
			}

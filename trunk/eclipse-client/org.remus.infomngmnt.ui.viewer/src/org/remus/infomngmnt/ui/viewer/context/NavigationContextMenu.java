...
import org.remus.infomngmnt.ui.viewer.context.action.DeleteNavigationAction;
import org.remus.infomngmnt.ui.viewer.context.action.MarkAsReadAction;
import org.remus.infomngmnt.ui.viewer.context.action.RefreshTreeAction;
import org.remus.infomngmnt.ui.viewer.context.action.RenameAction;
...
public class NavigationContextMenu implements IMenuListener, IPropertyListener,
	...
	public void init(final IActionBars actionBars) {
		...
		this.deleteAction = new DeleteNavigationAction(ViewerActivator.getDefault()
				.getEditService().getNavigationEditingDomain(), removeAllReferencesOnDelete());

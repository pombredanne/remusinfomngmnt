...
public class StrikeThroughAction extends Action implements Listener {
	...
	public StrikeThroughAction(final HtmlComposer composer) {
		super("Strikethrough", IAction.AS_CHECK_BOX);
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(
				"de.spiritlink.richhtml4eclipse",
				"tiny_mce/jscripts/tiny_mce/themes/advanced/images/strikethrough.gif"));

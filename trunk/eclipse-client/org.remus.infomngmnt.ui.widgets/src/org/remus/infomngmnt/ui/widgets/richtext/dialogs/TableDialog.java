 ...
 *******************************************************************************/
package org.remus.infomngmnt.ui.widgets.richtext.dialogs;
...
public class TableDialog extends TitleAreaDialog {
     ...
     * @param align
     */
    public TableDialog(Shell parentShell, String cellpadding, String cellspacing,
            String clazz, String style, String id, String align) {
        super(parentShell);

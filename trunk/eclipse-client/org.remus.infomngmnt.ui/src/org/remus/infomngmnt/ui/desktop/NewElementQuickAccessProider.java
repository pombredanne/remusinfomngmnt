...
public class NewElementQuickAccessProider extends QuickAccessProvider {
	...
	public NewElementQuickAccessProider(RuleResult result) {
		super();
		this.result = result;
	}
	...
	/* (non-Javadoc)
	 * @see org.remus.infomngmnt.common.ui.quickaccess.QuickAccessProvider#getElementForId(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.remus.infomngmnt.common.ui.quickaccess.QuickAccessProvider#getElements()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.remus.infomngmnt.common.ui.quickaccess.QuickAccessProvider#getId()
	 */
	@Override
	public String getId() {
		return "test";
	...
	/* (non-Javadoc)
	 * @see org.remus.infomngmnt.common.ui.quickaccess.QuickAccessProvider#getImageDescriptor()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.remus.infomngmnt.common.ui.quickaccess.QuickAccessProvider#getName()
	 */
	@Override

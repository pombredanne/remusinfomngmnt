...
public class GeneralCheckoutPage extends GeneralPage implements IMultipleInfoObjectSetter{
	...
	protected void doCreateNameElements(final Composite container) {
		...
		TableViewer tableViewer = new TableViewer(container, SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL);
		...
		tableViewer.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(final SelectionChangedEvent event) {
				...
				ISWTObservableValue swtKeyWords = SWTObservables.observeText(GeneralCheckoutPage.this.keywordsText, SWT.Modify);
				IObservableValue emfKeywords = EMFObservables.observeValue((EObject) ((IStructuredSelection) event.getSelection()).getFirstElement(), InfomngmntPackage.Literals.INFORMATION_UNIT__KEYWORDS);
				this.innerCtx.bindValue(swtKeyWords, emfKeywords, null, null);
				ISWTObservableValue swtDescription = SWTObservables.observeText(GeneralCheckoutPage.this.descriptionText, SWT.Modify);
				IObservableValue emfDescription = EMFObservables.observeValue((EObject) ((IStructuredSelection) event.getSelection()).getFirstElement(), InfomngmntPackage.Literals.INFORMATION_UNIT__DESCRIPTION);

...
public class NotificationView extends AbstractScrolledTitledView implements IEditingDomainProvider,
	...
	public static final String VIEW_ID = "org.remus.infomngmnt.ui.views.NotificationView"; //$NON-NLS-1$
	...
	private class NotificationMasterBlock extends MasterDetailsBlock {
		...
		protected void createMasterPart(final IManagedForm pManagedForm, final Composite parent) {
			...
			this.viewer.setContentProvider(new AdapterFactoryContentProvider(EditingUtil
					.getInstance().getAdapterFactory()));

			this.viewer
					.setLabelProvider(new NavigatorDecoratingLabelProvider(
						...
						public Font getFont(final Object object) {
							if (!((Notification) object).isNoticed()) {
								return ResourceManager
										.getBoldFont(NotificationMasterBlock.this.viewer.getTable()
												.getFont());
							}
							return null;
						}

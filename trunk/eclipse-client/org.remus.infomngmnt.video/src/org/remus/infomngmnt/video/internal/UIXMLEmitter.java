...
public class UIXMLEmitter implements IEmitter {
	...
	public Object emitt(final InformationUnit element) throws CoreException {
		...
		Long valueByNodeId = (Long) read
				.getValueByNodeId(VideoActivator.NODE_NAME_WIDTH);
		...
		try {
			...
			uixml.setBinaryReferences(Collections.singletonMap(
					id,
					InformationUtil.binaryReferenceToFile(
							binaryReferences.get(0), element)));
			return uixml;
